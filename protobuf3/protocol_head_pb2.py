...
_ARGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='offline', full_name='wlst.pb2.Args.offline', index=7,
...
_ARGS.fields_by_name['offline'].has_options = True
_ARGS.fields_by_name['offline']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
